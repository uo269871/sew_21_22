...
<head>
	...
	<link rel="stylesheet" href="102-Objetos-PHP-Flickr%20.css">
</head>
<body>
	<h1>Información de imágenes de <a href="https://www.flickr.com/services/developer/">Flickr</a></h1>
    <section>
        <h2>Código fuente PHP</h2>
        <?php
        $archivo = "102-CodigoPHP.php";
