...
<head>
    <meta charset="UTF-8"/>
    <title>Calculadora para diabéticos</title>
	<link rel="stylesheet" href="025-CalculadoraDiabetica.css"/>
</head>
<body>
	<h1>Calculadora para diabéticos</h1>  
    <section>
        <h2>Código fuente PHP</h2>
        <?php
            $archivo = "025-CodigoPHP.php";
