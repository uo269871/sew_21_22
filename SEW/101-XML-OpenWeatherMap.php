...
<head>
	...
	<link rel="stylesheet" href="101-XML-OpenWeatherMap.css">
</head>
<body>
	<h1>Datos meteorológicos en XML de <a href="http://openweathermap.org/">OpenWeatherMap</a></h1>
    <section>
        <h2>Código fuente PHP</h2>
        <?php
        $archivo = "101-CodigoPHP.php";
